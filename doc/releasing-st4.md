...
Downloading: https://oss.sonatype.org/content/repositories/snapshots/org/antlr/antlr4-tool-testsuite/4.1-SNAPSHOT/maven-metadata.xml
Uploading: https://oss.sonatype.org/content/repositories/snapshots/org/antlr/antlr4-tool-testsuite/4.1-SNAPSHOT/antlr4-tool-testsuite-4.1-20161211.173752-1.jar
Uploaded: https://oss.sonatype.org/content/repositories/snapshots/org/antlr/antlr4-tool-testsuite/4.1-SNAPSHOT/antlr4-tool-testsuite-4.1-20161211.173752-1.jar (3 KB at 3.4 KB/sec)
Uploading: https://oss.sonatype.org/content/repositories/snapshots/org/antlr/antlr4-tool-testsuite/4.1-SNAPSHOT/antlr4-tool-testsuite-4.1-20161211.173752-1.pom
Uploaded: https://oss.sonatype.org/content/repositories/snapshots/org/antlr/antlr4-tool-testsuite/4.1-SNAPSHOT/antlr4-tool-testsuite-4.1-20161211.173752-1.pom (3 KB at 6.5 KB/sec)
...
Uploading: https://oss.sonatype.org/content/repositories/snapshots/org/antlr/antlr4-tool-testsuite/4.1-SNAPSHOT/maven-metadata.xml
Uploaded: https://oss.sonatype.org/content/repositories/snapshots/org/antlr/antlr4-tool-testsuite/4.1-SNAPSHOT/maven-metadata.xml (774 B at 1.8 KB/sec)
...
```
...
What is the release version for "ANTLR 4"? (org.antlr:antlr4-master) 4.1: : 4.1
What is the release version for "ANTLR 4 Runtime"? (org.antlr:antlr4-runtime) 4.1: : 
What is the release version for "ANTLR 4 Tool"? (org.antlr:antlr4) 4.1: : 
What is the release version for "ANTLR 4 Maven plugin"? (org.antlr:antlr4-maven-plugin) 4.1: : 
What is the release version for "ANTLR 4 Runtime Test Generator"? (org.antlr:antlr4-runtime-testsuite) 4.1: : 
What is the release version for "ANTLR 4 Tool Tests"? (org.antlr:antlr4-tool-testsuite) 4.1: : 
What is SCM release tag or label for "ANTLR 4"? (org.antlr:antlr4-master) antlr4-master-4.1: : 4.1
What is the new development version for "ANTLR 4"? (org.antlr:antlr4-master) 4.1.1-SNAPSHOT:
...
```

Maven will go through your pom.xml files to update versions from 4.1-SNAPSHOT to 4.1 for release and then to 4.1.1-SNAPSHOT after release, which is done with:
...
```bash
cp ~/.m2/repository/org/antlr/antlr4-runtime/4.1/antlr4-runtime-4.1.jar ~/antlr/sites/website-antlr4/download/antlr-runtime-4.1.jar
cp ~/.m2/repository/org/antlr/antlr4/4.1/antlr4-4.1-complete.jar ~/antlr/sites/website-antlr4/download/antlr-4.1-complete.jar
cd ~/antlr/sites/website-antlr4/download
git add antlr-4.1-complete.jar
git add antlr-runtime-4.1.jar 
```
...
zip -r /tmp/antlr-javascript-runtime-4.1.zip antlr4
cp /tmp/antlr-javascript-runtime-4.1.zip ~/antlr/sites/website-antlr4/download
# git add, commit, push
```
...
git add antlr-javascript-runtime-4.1.zip
...
Copyright (C) Microsoft Corporation. All rights reserved.
  ...
  Successfully created package 'C:\Code\antlr4-fork\runtime\CSharp\runtime\CSharp\Antlr4.Runtime\lib\Release\Antlr4.Runtime.Standard.4.1.2.nupkg'.
```
...
cd runtime/Cpp
./deploy-macos.sh
cp antlr4-cpp-runtime-macos.zip ~/antlr/sites/website-antlr4/download/antlr4-cpp-runtime-4.1-macos.zip
```
...
cd runtime/Cpp
./deploy-source.sh
cp antlr4-cpp-runtime-source.zip ~/antlr/sites/website-antlr4/download/antlr4-cpp-runtime-4.1-source.zip
```
...
cd runtime/Cpp
deploy-windows.cmd
cp runtime\bin\vs-2015\x64\Release DLL\antlr4-cpp-runtime-vs2015.zip ~/antlr/sites/website-antlr4/download/antlr4-cpp-runtime-4.1-vs2015.zip
```
...
pushd ~/antlr/sites/website-antlr4/download
# vi index.html
git add antlr4cpp-runtime-4.1-macos.zip
git add antlr4cpp-runtime-4.1-windows.zip
git add antlr4cpp-runtime-4.1-source.zip
...
cd Java
jar xvf ~/.m2/repository/org/antlr/antlr4-runtime/4.1/antlr4-runtime-4.1-javadoc.jar
cd ../JavaTool
jar xvf ~/.m2/repository/org/antlr/antlr4/4.1/antlr4-4.1-javadoc.jar
