...
+ (id) newAnon
{
    [[TestFunctions_Anon1 alloc] init];
}
...
+ (id) newAnon
{
    [[TestFunctions_Anon2 alloc] init];
}
...
+ (id) newAnon
{
    [[TestFunctions_Anon3 alloc] init];
}
...
+ (id) newAnon
{
    [[TestFunctions_Anon4 alloc] init];
}
...
+ (id) newAnon
{
    [[TestFunctions_Anon5 alloc] init];
}
...
+ (id) newAnon
{
    [[TestFunctions_Anon6 alloc] init];
}
...
+ (id) newAnon
{
    [[TestFunctions_Anon7 alloc] init];
}
...
- (void) test25FirstWithListOfMaps
{
    ...
    NSMutableDictionary *m1 = [NSMutableDictionary dictionaryWithCapacity:16];
    NSMutableDictionary *m2 = [NSMutableDictionary dictionaryWithCapacity:16];
    [m1 setObject:@"Ter" forKey:@"x5707"];
    [e add:@"maps" value:m1];
    [m2 setObject:@"Tom" forKey:@"x5332"];
    [e add:@"maps" value:m2];
    NSString *expected = @"x5707";
    NSString *result = [e render];
    STAssertTrue( [expected isEqualTo:result], @"Expected \"%@\" but got \"%@\"", expected, result );
    AMutableArray *list = [TestFunctions_Anon6 newAnon];
...
- (void) test26FirstWithListOfMaps2
{
    ...
    NSString *result = [e render];
    STAssertTrue( [expected isEqualTo:result], @"Expected \"%@\" but got \"%@\"", expected, result );
    AMutableArray *list = [TestFunctions_Anon7 newAnon];
    [e add:@"maps" value:list];
    expected = @"Ter!";
    result = [e render];
    STAssertTrue( [expected isEqualTo:result], @"Expected \"%@\" but got \"%@\"", expected, result );
