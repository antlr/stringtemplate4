...
into your favorite lib directory such as /usr/local/lib on UNIX:
  ...
  * antlr-complete.jar; http://www.antlr.org/download/antlr-3.5-rc-1-complete.jar
  * ST.jar; see http://www.stringtemplate.org/download/ST-4.0.7-rc-1.jar

Add to your CLASSPATH. On UNIX that looks like

$ export CLASSPATH="/usr/local/lib/antlr-3.5-rc-1-complete.jar:/usr/local/lib/ST-4.0.7-rc-1.jar:$CLASSPATH"
...
zip-source:
    [mkdir] Created dir: /usr/local/website/st/depot/ST4/java/main/dist/ST-4.0.7-rc-1
    [mkdir] Created dir: /usr/local/website/st/depot/ST4/java/main/dist/ST-4.0.7-rc-1/src
     [copy] Copying 53 files to /usr/local/website/st/depot/ST4/java/main/dist/ST-4.0.7-rc-1/src
     [copy] Copying 4 files to /usr/local/website/st/depot/ST4/java/main/dist/ST-4.0.7-rc-1
     [copy] Copying 1 file to /usr/local/website/st/depot/ST4/java/main/dist/ST-4.0.7-rc-1/lib
      [zip] Building zip: /usr/local/website/st/depot/ST4/java/main/dist/ST-4.0.7-rc-1-src.zip

build-jar:
      [jar] Building jar: /usr/local/website/st/depot/ST4/java/main/dist/ST-4.0.7-rc-1.jar
